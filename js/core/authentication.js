 	...
 	function check_login_status() {
	    ...
	    if (typeof session_id == "undefined" || session_id == null || session_id == "") {
	    	if(jQuery("#login_status_pane").length >= 1) {
	        	jQuery("#login_status_pane").html('<a href="#" id="get_settings_button" class="get_settings">Settings</a>' + '<a href="#" id="get_login" class="getloginform">Login or Signup</a>');
	    	} else {
	    	...
	    	if(jQuery("#login_status_pane").length >= 1) {
		        jQuery("#login_status_pane").html('<a href="#" id="get_settings_button" class="get_settings">Settings</a>');
			} else {
