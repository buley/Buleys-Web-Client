	...
	function load_page_title_info(page_info) {
	    if (typeof page_info.name != 'undefined' && jQuery("a .topic_name").length > 0 && !jQuery("#page_meta").indexOf( "<a href='/" + page_info.type + "/" + page_info.key + "' class='topic_name'>" + page_info.name + "</a>") ) {
	        jQuery("#page_meta").append("<a href='/" + page_info.type + "/" + page_info.key + "' class='topic_name'>" + page_info.name + "</a>");
	    }
	    if (typeof page_info.subsector != 'undefined' && jQuery("a .sector_name").length > 0 && !jQuery("#page_meta").indexOf( "<a href='/sector/" + getURLSlug(page_info.subsector).toLowerCase() + "' class='sector_name'>" + page_info.subsector + "</a>" ) ) {
	        jQuery("#page_meta").append("<a href='/sector/" + getURLSlug(page_info.subsector).toLowerCase() + "' class='sector_name'>" + page_info.subsector + "</a>");
	    }
	
	    if (typeof page_info.sector != 'undefined' && jQuery("a .subsector_name").length > 0 && !jQuery("#page_meta").indexOf( "<a href='/sector/" + getURLSlug(page_info.sector).toLowerCase() + "' class='subsector_name'>" + page_info.sector + "</a>" ) ) {
